...
const en = {
    ...
    raid: {
        ...
        'select5': 'Please select a caching strategy',
        'notinit': 'No Read Ahead',
        'quit': 'Read Ahead',
        'all1': 'Adaptive Read Ahead',
        ...
        'diskinit': 'Disk initialization',
        'stopinit': 'Stop disk initialization'
    },
    raidMgr: {
        'alarm': 'Alarm status',
        'global': 'JBOD Settings',
        'start': 'Enable alarm',
        'stop': 'Stop alarm',
